...
/** Writes the {@link ApiResponse} envelope for authenticated-but-forbidden requests (403). */
@Component
...
public class RestAccessDeniedHandler implements AccessDeniedHandler {
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response,
        ...
        objectMapper.writeValue(
                response.getWriter(),
                ApiResponse.fail(ErrorCode.ACCESS_DENIED, ErrorCode.ACCESS_DENIED.getMessage()));
    }
}
